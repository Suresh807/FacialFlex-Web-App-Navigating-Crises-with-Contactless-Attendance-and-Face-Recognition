...
#######################################################
## Disable Warnings
#st.set_option('deprecation.fileUploaderEncoding', False)
#st.set_option('deprecation.fileUploaderEncoding', False)
################################################### Defining Static Data ###############################################
st.sidebar.image('https://gumlet.assettype.com/swarajya%2F2018-09%2Fb6568b49-d958-41b2-a3d0-7f77a6495803%2F7a56e8a7_b4a0_47a1_9c5a_9382a344b079.jpg?rect=0%2C61%2C585%2C329&q=75&auto=format%2Ccompress&w=1200',
                 use_column_width=False)
st.sidebar.markdown("""
                    > Made by [*Suresh Kumar K*](https://www.linkedin.com/in/suresh-kumar-k-398439237/)
                    """)

user_color      = '#000000'
title_webapp    = "FacialFlex Web App: Navigating Crises with Contactless Attendance and Face Recognition"
...
def main():
    ...
    st.sidebar.info("FacialFlex Web App represents a groundbreaking leap in attendance tracking within educational institutions. By harnessing state-of-the-art facial recognition technology, the application offers a seamless and contactless solution for efficiently managing attendance records. Gone are the days of manual attendance sheets or card-based systems—I enable students to effortlessly mark their presence by simply facing the camera, ensuring a swift and hygienic process. With advanced face recognition algorithms, my system guarantees a high level of precision, minimizing errors and unauthorized entries. The streamlined storage of attendance data, including student names and records, in an Excel spreadsheet enhances accessibility for educators and administrative staff. Moreover, FacialFlex's integration with Streamlit provides a user-friendly and interactive interface, streamlining the attendance management process. This innovative solution not only significantly reduces the time spent on manual tracking but also promotes accuracy, accountability, and a contactless, hygienic environment. As I navigate through crises, FacialFlex stands as a beacon of progress in attendance management, contributing to the efficiency, security, and modernization of our educational systems. Embrace the future with FacialFlex Web App, where technology meets the evolving needs of our educational landscape.")
    ###################################################
